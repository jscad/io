...
function convertToBlob (objects, params) {
  ...
  var outputFormatHandlers = {
    ...
    stl: function (object) { return CSGToStla(object, {version: version}); }, // CSG to STL ASCII
    stla: function (object) { return CSGToStla(object, {version: version}); }, // CSG to STL ASCII
    stlb: function (object) { return CSGToStlb(object, {webBlob: true, version: version}); }, // CSG to STL BINARY
    dxf: function (object) { return CAGToDxf(object, {version: version}); }, // CAG to DXF
    svg: function (object) { return CAGToSvg(object, {version: version}); }, // CAG to SVG
    x3d: function (object) { return CSGToX3D(object.fixTJunctions(), {version: version}); },
    json: function (object) { return CAGToJson(object, {version: version}); }, // CSG or CAG to JSON
...
function createConversionWorker (onDone) {
  ...
  var worker = index(require('./conversionWorker.js'));
...
exports.createConversionWorker = createConversionWorker;
